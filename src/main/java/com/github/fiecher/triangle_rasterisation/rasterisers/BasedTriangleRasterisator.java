...
public class BasedTriangleRasterisator implements TriangleRasteriser {
...
//            w.setColor(x, y, pointColor(x, y));
    ...
    public void draw(final Point2D p1, final Point2D p2, final Point2D p3) {
        ...
        final Triangle triangle = new Triangle(getCtx().getPixelWriter(), getColor(), p1, p2, p3);
        triangle.draw();
    }
